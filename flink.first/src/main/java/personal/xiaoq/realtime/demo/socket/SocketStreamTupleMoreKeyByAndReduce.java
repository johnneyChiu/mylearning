...
public class SocketStreamTupleMoreKeyByAndReduce {
    ...
    public static void main(String[] args) throws Exception {
       ...
       // wordKeyBySteam.print();
        ...
        SingleOutputStreamOperator<Tuple4<String, String, String, Double>> reduceStream = wordKeyBySteam.reduce((Tuple4<String, String, String, Double> var1, Tuple4<String, String, String, Double> var2) -> {
            return Tuple4.of(var1.f0, var1.f1, var2.f2, var1.f3 + var2.f3);
        }).returns(Types.TUPLE(Types.STRING, Types.STRING, Types.STRING, Types.DOUBLE));
        reduceStream.print();
